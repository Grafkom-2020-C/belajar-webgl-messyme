function main() {
  ...
  var vertices = [
    0.7, 0, 1, 1, 1,           // titik A
    0, -0.7, 0.47, 0.82, 0.59, // titik B
    -0.7, 0, 0.24, 0.4, 0.72,  // titik C
    0.7, 0, 0.68, 0.81, 0.53,  // titik A
    0, 0.7, 0.98, 0.94, 0.47,  // titik D
    -0.7, 0, 1, 0.32, 0.38,    // titik C
  ...
  gl.vertexAttribPointer(aPositionLoc, 2 , gl.FLOAT, false, 5*Float32Array.BYTES_PER_ELEMENT, 0); //attribute yg di GPU menunjuk ke vertexBuffer
